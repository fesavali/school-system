  ...
  if(end($filename) == "csv")
  {
   ...
   while($data = fgetcsv($handle))
   {
    ...
    $query = "
     ...
     (product_id, product_category,product_name, product_price) VALUES ('$product_id', '$product_category', '$product_name', '$product_price')";
    mysqli_query($connect, $query);
   }
   fclose($handle);
   header("location: update2.php?updation=1");
  }
  else
  {
