...
$query = "SELECT * FROM message WHERE message_id = (SELECT parent_no FROM parent_table WHERE parent_name =
 '".$_SESSION['username']."')";
$statement = $connect->prepare($query);
$statement->execute();
$result = $statement->fetchAll();

$query1 = "SELECT * FROM message WHERE message_id = 1";
$statement1 = $connect->prepare($query1);
$statement1->execute();
$result1 = $statement1->fetchAll();

$query2 = "SELECT * FROM message WHERE message_id = 12";
