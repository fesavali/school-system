...
$query = "SELECT * FROM message WHERE message_id = (SELECT teacher_no FROM teacher_table WHERE teacher_name ='".$_SESSION['username']."')";
$statement = $connect->prepare($query);
$statement->execute();
$result = $statement->fetchAll();

$query1 = "SELECT * FROM message WHERE message_id = 10";
